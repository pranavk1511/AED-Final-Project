...
public class JobWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public JobWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization,Enterprise enterprise,CitizenDirectory vd,EcoSystem business) 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnViewAllCitizen, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 110, -1, -1));
    ...
    private void btnViewAllCitizenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAllCitizenActionPerformed
        ...
        userProcessContainer.add("VViewAllCitizen", rg);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
