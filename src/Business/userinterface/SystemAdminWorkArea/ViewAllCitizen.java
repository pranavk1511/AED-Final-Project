...
public class ViewAllCitizen extends javax.swing.JPanel {
   private JPanel userProcessContainer;
    ...
    CitizenDirectory Citizen_Dir;
    /**
     * Creates new form ViewAllCitizenss
     */
    public ViewAllCitizen(JPanel userProcessContainer, EcoSystem system,CitizenDirectory vet_Dir) {
        initComponents();
        this.Citizen_Dir = vet_Dir;
        this.userProcessContainer = userProcessContainer;
        this.system = system;
        populateCitizensDetails();
    }
 public void populateCitizensDetails() {
        int rowCount = tblViewAllCitizens.getRowCount();
        DefaultTableModel model = (DefaultTableModel) tblViewAllCitizens.getModel();
    ...
    private void initComponents() {
        ...
        tblViewAllCitizens.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Citizen Name ", "SSN", "Age", "Gender", "Current Concern", "Criticality level"
            }
        ));
        jScrollPane1.setViewportView(tblViewAllCitizens);
        ...
        jButton1.setText("Track Citizen");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (selectedRow >= 0) {
            Citizen v = (Citizen) tblViewAllCitizens.getValueAt(selectedRow, 0);
