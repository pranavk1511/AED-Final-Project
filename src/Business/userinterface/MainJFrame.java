...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
         initComponents();
       Citizen_Di = new CitizenDirectory();
...
//        homePic.setIcon(scaled);
    ...
    public CitizenDirectory getDir() {
        return Citizen_Di;
    }
    ...
    private void initComponents() {
        ...
        loginJButton.setBackground(new java.awt.Color(255, 204, 102));
        loginJButton.setFont(new java.awt.Font("Poppins", 1, 14)); // NOI18N
        ...
        logoutJButton.setFont(new java.awt.Font("Poppins", 1, 14)); // NOI18N
        ...
        homePic.setFont(new java.awt.Font("Poppins", 1, 14)); // NOI18N
        homePic.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        homePic.setText("Smart City Mgmt");
        jPanel1.add(homePic, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 150, 30));
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if (userAccount == null) {
            UserAccount CitizenuserAccount =  system.getUad().authenticateUser(userName, password);
            if (CitizenuserAccount != null) {
                System.out.println("Citizen Login Succesful");
                CitizenWorkAreaJPanel panel = new CitizenWorkAreaJPanel(container, CitizenuserAccount, Citizen_Di, system);
            ...
            CardLayout layout = (CardLayout) container.getLayout();
            container.add("workArea", userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inEnterprise, system, Citizen_Di, user_Dir));
            layout.next(container);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
                GuestUserJPanel panel = new GuestUserJPanel(container, system,Citizen_Di, user_Dir);
