...
public class TempHousingWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public TempHousingWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization tempHousingOrganization, Enterprise enterprise, CitizenDirectory vd,EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(btnViewAllCitizen, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 110, -1, -1));
    ...
    private void btnViewAllCitizenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAllCitizenActionPerformed
        ...
        userProcessContainer.add("ViewAllCitizenss", rg);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
